...
import {ActionTypes, requestClosestNode, retreivePublicKey, retreiveElectionPermissions, retreiveAdminPublicKey} from "~/datatypes";
...
export function useCommon() {
    ...
    useEffect(() => {
        ...
        dispatch(retreiveAdminPublicKey());
